...
class Game():
    ...
    def display_credits(self, surface):
        line1 = FONT_LG.render("Credits: ", 1, WHITE)
        line2 = FONT_MD.render("Game By: Carrington Jones ", 1, WHITE)
        line3 = FONT_SM.render("Wanna Play Again? Press R to Reset ", 1, WHITE)
