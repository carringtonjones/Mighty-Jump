...
#things to do:
#disable p on the keyboard to pause the game
#enable the start button to unpause the game
#when starting a new level enable the a button to start
#when restarting the game toggle the start key
#get music and sound function working and get new images
#make some custom blocks on piskel
...
# Fonts
FONT_SM = pygame.font.Font("assets/fonts/kenpixel_blocks.ttf", 32)
FONT_MD = pygame.font.Font("assets/fonts/kenpixel_blocks.ttf", 64)
FONT_LG = pygame.font.Font("assets/fonts/kenpixel_blocks.ttf", 72)
...
# Images
guy_walk1 = load_image("assets/character/guy_walk1.png")
guy_walk2 = load_image("assets/character/guy_walk2.png")
guy_walk3 = load_image("assets/character/guy_walk3.png")
guy_walk4 = load_image("assets/character/guy_walk4.png")
guy_jump = load_image("assets/character/guy_jump.png")
guy_idle = load_image("assets/character/guy_idle.png")

guy_lives = load_image("assets/character/guy_walk1.png")

hero_images = {"run": [guy_walk1, guy_walk2, guy_walk3, guy_walk4],
               "jump": guy_jump,
               "idle": guy_idle}

block_images = {"TL": load_image("assets/tiles/ground_stone_broken.png"),
                "TM": load_image("assets/tiles/ground_stone_broken.png"),
                "TR": load_image("assets/tiles/top_right.png"),
                "ER": load_image("assets/tiles/ground_stone_small.png"),
                "EL": load_image("assets/tiles/ground_stone_small.png"),
                "TP": load_image("assets/tiles/ground_stone_small.png"),
                "CN": load_image("assets/tiles/ground_stone_broken.png"),
                "LF": load_image("assets/tiles/ground_stone_broken.png"),
...
#wanna try spinning coin, later in game
...
monster_img1 = load_image("assets/enemies/scared-1.png")
monster_img2 = load_image("assets/enemies/gothit-1.png")
monster_images = [monster_img1, monster_img2]

groundmonster_img1 = load_image("assets/enemies/scared-1.png")
groundmonster_img2 = load_image("assets/enemies/gothit-1.png")
groundmonster_images = [groundmonster_img1, groundmonster_img2]
...
class Character(Entity):
    ...
    def check_flag(self, level):
        ...
        if len(hit_list) > 0:
            ...
            if game.level.time_limit >= 330:
                self.score += 500
            if 329 >= game.level.time_limit >= 150:
                self.score += 250
            if 149 >= game.level.time_limit >= 50:
                self.score += 175
            else:
                self.score += 105
...
class Level():
    ...
    def __init__(self, file_path):
        ...
        self.time_limit = map_data['time-limit'] 
        ...
        for item in map_data['groundmonsters']:
            x, y = item[0] * GRID_SIZE, item[1] * GRID_SIZE
            self.starting_enemies.append(Groundmonster(x, y, groundmonster_images))
...
class Game():
    ...
    def advance(self):
        ...
        self.hero.score += self.level.time_limit*10
    ...
    def display_splash(self, surface):
        ...
        line2 = FONT_SM.render("Press A to start.", 1, WHITE)
        img = pygame.image.load("assets/backgrounds/black_splashscreen.png")
        guy = pygame.image.load("assets/character/guy_splashscreen.png")
        monster = pygame.image.load("assets/enemies/gothit_splash.png")
        monster2 = pygame.image.load ("assets/enemies/scared_splash.png")
        ...
        surface.blit(guy, (400, 512))
        surface.blit(monster, (1000, 512))
        surface.blit(monster2, (600, 520))
    ...
    def process_events(self):
        ...
        rt_x, rt_y = my_controller.get_right_stick()
        ...
        if self.stage == Game.PLAYING and self.level.time_limit > 0:
            self.timer_ticks  += 1
            if self.timer_ticks % self.refresh_rate == 0:
                self.level.time_limit -= 1
    ...
    def draw(self):
        ...
        if self.stage == Game.SPLASH:
            ...
            self.display_message(self.window, "Ready?!!!", "Press any key to start.")
             ...
             self.display_message(self.window, "GAME IS PAUSED", "Press START to continue.")
        elif self.stage == Game.LEVEL_COMPLETED:
            self.display_message(self.window, "Level Complete", "Press A to continue.")
